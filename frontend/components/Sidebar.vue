  ...
  <aside
    ...
    <div class="h-20 flex items-center px-8 border-b border-white/5 relative z-10">
      <div class="flex items-center gap-3">
        <img src="/logo.png" alt="OptiSight Logo" class="h-10 w-10 object-contain" />
        <span
          class="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-indigo-400 to-sky-400">OptiSight</span>
      </div>
    </div>
    ...
    <div class="p-4 border-t border-white/5 relative z-10">
      <NuxtLink to="/settings"
        ...
        <div
          class="w-9 h-9 rounded-full bg-slate-700 flex-shrink-0 border-2 border-indigo-500/20 overflow-hidden group-hover:border-indigo-500/50 transition-colors">
